...
def rus_convert(value, unit_in, unit_out):
    rus_dict = {'metre': 1, 'vershok': 48, 'pyad': 12, 'lokot': 6, 'arshin': 3, 'sazhen': 1, 'versta': 0.002,
                'poprishche': 0.0001}
    return value * rus_dict[unit_out] / rus_dict[unit_in]


def metric_convert(value, unit_in):
    to_meter_dict = {'metre': 2.136, 'vershok': 8, 'pyad': 2, 'lokot': 6, 'arshin': 3, 'sazhen': 1, 'versta': 0.002,
                     'poprishche': 0.0001}
